...
import EditeAbout from "./EditeAbout/EditeAbout";
              ...
              <div className="About-details">
                ...
                <div id="Overview" class="w3-container city" >
                  ...
                  <div className="About-edit-div">
                    <div className="About-Pen-Div btn" onClick={on}>
                      <HiPencil style={{ fontSize: "18px" }} />
                    </div>
                  </div>

                  <div className="About-icon">
                    <MdBusinessCenter /> <span className="About-icon-text">{item.work ? item.work : "no work to show"}</span>
                  </div>

                  <div className="About-icon">
                    <MdSchool /> <span className="About-icon-text">no High School to show</span>
                  </div>
                  ...
                  <div className="About-icon">
                    <AiFillHeart /> <span className="About-icon-text">Relation</span>
                  </div>
                </div>
                ...
                <div id="Work" class="w3-container city" style={{ display: "none" }}>
                  ...
                  <div className="About-icon">
                    ...
                    <MdBusinessCenter /> <span style={{ color: "#a9acb1" }} className="About-icon-text" >No places to show</span>
                  </div>
                  <div className="About-icon">
                    <div style={{ color: "white", fontSize: "17px" }}> University </div>
                    <MdSchool /> <span style={{ color: "#a9acb1" }} className="About-icon-text" >No places to show</span>
                  </div>
                  <div className="About-icon">
                ...
                <div id="Contact" class="w3-container city" style={{ display: "none" }}>
                  ...
                  <div className="About-icon">
                    <MdEmail /> <span className="About-icon-text" style={{ textTransform: "lowercase" }}>ajayanandrao02@outlook.com</span>
                  </div>
                  <div className="About-icon">
                    <BsFillPhoneFill /> <span className="About-icon-text">{item.MobileNumber}</span>
                  </div>
                  <div className="About-icon">
                    <ImLink /> <span className="About-icon-text" style={{ textTransform: "lowercase" }}>https://ajayanandrao.com</span>
                  </div>
                </div>
