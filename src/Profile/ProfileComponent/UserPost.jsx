...
import "./../../Feed/EditOverlay/Suggest.scss";
...
const UserPost = ({ post, CurrentUser }) => {
  ...
  // const Data = api?.map((post) => {

  //   //   // ------------------------------------------------------------------------
  //   function OptionBtn(id) {
  //     const dropdownContent = document.getElementById(`myDropdown-${id}`);
  //     dropdownContent.classList.toggle("show");
  //     if (currentuser && currentuser.displayName !== post.displayName) {
  //       document.getElementById(`edit-${id}`).style.display = "none";
  //     }
  //   }

  //   const isCurrentUserPost =
  //     currentuser && post.displayName === currentuser.displayName;
  ...
  //                 <div className="Feed-Post-Text d-flex">{post.name}</div>
